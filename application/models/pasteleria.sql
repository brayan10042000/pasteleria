...
--
-- Base de datos: `tokokue`
--

-- --------------------------------------------------------

--
-- Estructura de la tabla para `tbl_producto`
--
...
--
-- Estructura de la tabla para `tbl_imagen`
--
...
--
-- Estructura de la tabla para `tbl_categoria`
--
...
--
-- Estructura de la tabla para `tbl_cliente`
--
...
--
-- Estructura de la tabla para `tbl_cuenta`
--
...
--
-- Estructura de la tabla para `tbl_detalle_transaccion`
--
...
--
-- Estructura de la tabla para `tbl_configuracion`
--
...
--
-- Estructura de la tabla para `tbl_transaccion`
--
...
--
-- Estructura de la tabla para `tbl_usuario`
--
...
INSERT INTO `tbl_usuario` (`id_usuario`, `nombre_usuario`, `nombre_acceso`, `contraseña`) VALUES
...
--
-- AUTO_INCREMENT para la tabla `tbl_producto`
--
ALTER TABLE `tbl_producto`
  MODIFY `id_producto` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;

--
-- AUTO_INCREMENT para la tabla `tbl_imagen`
--
ALTER TABLE `tbl_imagen`
  MODIFY `id_imagen` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=37;

--
-- AUTO_INCREMENT para la tabla `tbl_categoria`
--
ALTER TABLE `tbl_categoria`
  MODIFY `id_categoria` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;

--
-- AUTO_INCREMENT para la tabla `tbl_cliente`
--
ALTER TABLE `tbl_cliente`
  MODIFY `id_cliente` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT para la tabla `tbl_cuenta`
--
ALTER TABLE `tbl_cuenta`
  MODIFY `id_cuenta` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT para la tabla `tbl_detalle_transaccion`
--
ALTER TABLE `tbl_detalle_transaccion`
  MODIFY `id_detalle` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=38;

--
-- AUTO_INCREMENT para la tabla `tbl_transaccion`
--
ALTER TABLE `tbl_transaccion`
  MODIFY `id_transaccion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;

--
-- AUTO_INCREMENT para la tabla `tbl_usuario`
--
ALTER TABLE `tbl_usuario`
